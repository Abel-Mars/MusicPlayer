...
import static com.example.musicplayer.MainActivity.music_data;
...
public class Music_Play extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
       ...
       // like =(Button)findViewById(R.id.like);
        ...
        /*like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==0){
                    music_this.setFlag(1);
                    flag=1;
                    Toast.makeText(Music_Play.this,"加入歌单",Toast.LENGTH_SHORT).show();
                    //like.setText("喜欢(已入)");
                }
                else{
                    //music_this.setFlag(0);
                    Toast.makeText(Music_Play.this,"已加入歌单，无需再操作",Toast.LENGTH_SHORT).show();
                    //like.setText("喜欢(未入)");
                }
            }
        });*/
        modle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(modles==1){
                    ...
                    modle.setBackgroundResource(R.drawable.circle);
                }
    ...
    private Bitmap getAlbumArt(Context context,int album_id) {
        ...
        if (album_art != null) {
            ...
            bm = BitmapFactory.decodeResource(context.getResources(), R.drawable.a1);
        }
        return bm;
    }
    @Override
